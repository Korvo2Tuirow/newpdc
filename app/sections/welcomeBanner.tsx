...
export const WelcomeBanner = () => {
    ...
    return(
        ...
        <div className="p-8 mt-5 text-4xl font-bold flex justify-center text-center  w-screen max-w-[1000px] text-gray-700 ">
          🍔🔥 Bem-vindo ao Point do Canal – O Sabor que Conquista!
        </div>

        <div className="p-8  flex  w-screen text-2xl text-center text-gray-600 w-screen  max-w-[1000px]">
          ...
          inesquecível. Peça agora e descubra o verdadeiro sabor. ❤️ Feito com paixão. 🚀 Delivery
          rápido, faça seu pedido agora mesmo!
        </div>
      </div>
    )
}