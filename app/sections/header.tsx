  ...
  return (
    <>
      <div className="flex  w-full h-screen overflow-hidden ">
        ...
        <div className="absolute flex items-center justify-center w-full h-screen z-10  object-cover ">
